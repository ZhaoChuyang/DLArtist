...
@section('content')
    ...
    <!--编辑器部分-->
    <section class="fdb-block" style="background-image: url(svg/yellow.svg);">
        <div class="container">
...
@section('script')
    ...
    <script>
        ...
        $('#edit').froalaEditor({
            zIndex: -2,
            iframe: true,
            toolbarButtons: [ 'fullscreen', '|', 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'paragraphFormat', 'formatOL', 'formatUL', 'quote', 'insertLink', 'insertImage','|', 'insertHR', 'clearFormatting', 'html', 'wirisEditor', 'wirisChemistry'],

            imageEditButtons: ['imageReplace', 'imageAlign', 'imageCaption', 'imageRemove', 'imageLink', 'imageDisplay', 'imageStyle', 'imageAlt', 'imageSize', 'imageTUI'],
            //documentReady: true,
            height: 600,
            language: 'zh_cn',
