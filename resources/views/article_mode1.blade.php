...
<head>
    ...
    <link href="model_css/styles/styles.css" rel="stylesheet" type="text/css" />
    <link href="model_css/styles/dossiers/01.css" rel="stylesheet" type="text/css" />
    <link href="model_css/slideshow.css" rel="stylesheet" type="text/css">
    <script src="model_js/js/Hyphenator.js" type="text/javascript"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript" src="model_js/js/tmt_core.js"></script>
    <script type="text/javascript" src="model_js/js/tmt_net.js"></script>
    <script type="text/javascript" src="model_js/js/tmt_csi.js"></script>
    <script src="model_js/js/jquery.touchSwipe-1.2.1.js" type="text/javascript"></script>
    <script src="model_js/js/slideshow.js"></script>
</head>
<body>
...
<div class="hyphenate">
    ...
    <div class="content-element">
        <div class="large-column float-left">
            <p><em>Laker</em> is built on top of the Baker ebook Framework</a> and the Less CSS Framework</a>. Basically it's a set of files, styles, tips and tricks for building digital publications with HTML5.</p>
            <p>This publication demonstrates the main features of <em>Laker</em>. Take a look at the code and the documentation on www.lakercompendium.com</a> to see how it's done. It's not that hard! ;) <br />
            </p>
            <hr /><br /></p>
        </div>
        <div class="large-column float-left">
            ...
            <div class="media-right">
                <img src="images/dossier-01/image-in-text.jpg" width="400" height="600" />
            </div>
    ...
    <div class="slideshow-container" style="margin-left: 28px;">
        <div class="mySlides fade">
            ...
            <img src="images/dossier-01/nyc1.jpg" style="width:100%">
            <div class="text">New York City #1</div>
        </div>

        <div class="mySlides fade">
            <div class="numbertext">2 / 3</div>
            <img src="images/dossier-01/nyc2.jpg" style="width:100%">
            <div class="text">New York City #2</div>
        </div>

        <div class="mySlides fade">
            <div class="numbertext">3 / 3</div>
            <img src="images/dossier-01/nyc3.jpg" style="width:100%">
            <div class="text">New York City #3</div>
        </div>
