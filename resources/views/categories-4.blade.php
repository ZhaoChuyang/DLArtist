            ...
            <div class="container">
                <div class="row no-margin">
                    <div class="col-md-12 padding-leftright-null">
                        <div id="page-header">
                            <div class="text">
                                <h1 class="margin-bottom-small">技术博客<span class="color">.</span></h1>
                            ...
                            <section id="nav" class="padding-onlytop-lg">
                                <div class="row">
                                    @if(!$up)
                                        <div class="col-xs-6">
                                            <div class="nav-left">
                                                <a href="/categories-4?page={{$current-1}}" class="btn-alt small shadow margin-null"><i class="icon ion-ios-arrow-left"></i><span>上一页</span></a>
                                            </div>
                                        </div>
                                    @endif
                                    @if($up==2)
                                        <script>
                                            window.location.href="/categories-4?page={{$current}}";
                                        </script>
                                        <div class="col-xs-6">
                                            <div class="nav-left">
                                                <a href="/categories-4?page={{$current-1}}" class="btn-alt small shadow margin-null invisible"><i class="icon ion-ios-arrow-left"></i><span>上一页</span></a>
                                            </div>
                                        </div>
                                    @endif
                                    @if($up==1)
                                    ...
                                    @if(!$down)
                                        <div class="col-xs-6">
                                            <div class="nav-right">
                                                <a href="/categories-4?page={{$current+1}}"class="btn-alt small shadow margin-null"><span>下一页</span><i class="icon ion-ios-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    @endif
                                    @if($down==2)
                                        ...
                                        <div class="col-xs-6">
                                            <div class="nav-left">
                                                <a href="/categories-4?page={{$current+1}}" class="btn-alt small shadow margin-null invisible"><i class="icon ion-ios-arrow-left"></i><span>下一页</span></a>
                                            </div>
                                        </div>
                                    @endif
                                    @if($down==1)
